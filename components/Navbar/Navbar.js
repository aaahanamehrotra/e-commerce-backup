  ...
  return (
    <nav className={navStyles.navbar}>
      ...
      <div className={[navStyles.navbar, navStyles.mobileNav].join(" ")}>
        {!open ? <FontAwesomeIcon icon={faBars} className={navStyles.hamburger} onClick={() => setOpen(!open)}/> : <FontAwesomeIcon icon={faXmark} className={navStyles.hamburger} onClick={() => setOpen(!open)}/>}
        {
        open && 
